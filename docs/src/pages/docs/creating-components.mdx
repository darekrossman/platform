...
```jsx noInline
// Our modal consists of a container, an overlay, and content container.
// All styling is accomplished via our ESS UI primitives and their system
// styling props, along with a couple variants defined in our theme.
...
// Let's render a component that makes use of our modal.
